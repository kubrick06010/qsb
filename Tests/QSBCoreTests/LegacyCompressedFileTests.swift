...
@Test func encodesAndSolvesFacilitiesJSONEnvelopes() throws {
    ...
    let decodedLocationSolutionDocument = try JSONDecoder().decode(FacilitiesSolutionDocument.self, from: locationSolutionJSON)
    ...
    let decodedLineBalancingSolutionDocument = try JSONDecoder().decode(FacilitiesSolutionDocument.self, from: lineBalancingSolutionJSON)
    ...
    let decodedLayoutSolutionDocument = try JSONDecoder().decode(FacilitiesSolutionDocument.self, from: layoutSolutionJSON)
